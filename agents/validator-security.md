...
- Follow `.docs/agents/validation-agent.md` (security stage) and `.docs/agents/security.md`: auth and authorization boundaries, input validation, data exposure, secrets handling, dependency changes.
