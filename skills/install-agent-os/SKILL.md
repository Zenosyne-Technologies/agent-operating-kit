...
7. **Map model tiers** to currently available models (frontier orchestrator / escalation / default worker / micro) and write the concrete names into CLAUDE.md's dispatch table.
...
10. **Report**: what was installed, the selected PM tool + its level configuration, the tier mapping, tracker structure status, and any placeholder you could not resolve.
