...
8. **Commit** the added files per the attribution policy chosen in step 5 — commit directly, do not ask for approval (autocommit is kit policy; the installed rules apply it to all future work too).
