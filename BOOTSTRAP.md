...
9. Report: what was installed, the selected PM tool + its level configuration, the tier mapping, tracker structure status, and any placeholder you could not resolve.
