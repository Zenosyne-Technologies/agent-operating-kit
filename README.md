...
scripts/plan-claude-md-split.sh      read-only planner for the one-time v0.33.0 split — classifies each project-file line kit / near-kit / attribution / title / project
