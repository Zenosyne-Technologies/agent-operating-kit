...
1. **New activity rule** → add `templates/marvin/agents/<activity>.md` (lean, one activity), add its reference line to the cascade in `templates/Codex.core.md`, update the README inventory.
