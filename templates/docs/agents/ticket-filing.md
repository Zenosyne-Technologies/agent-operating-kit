...
- {{TRACKER_COORDINATES: Jira → site URL + project key · Linear → team + project · GitHub → owner/repo}}; new issues → Backlog (or the workflow's initial status — the guide records which).
