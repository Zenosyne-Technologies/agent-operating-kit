...
| Force-push, rewrite pushed history, `rm -rf`, or mass-move/rename across the tree (except the run-report prune, exactly as `briefing.md` item 11 defines it, symlink refusal included) | REQUEST_APPROVAL |
