...
| Copy or restore a file or DB into a destination that already exists, or that is (or sits behind) a symlink — ordinary edits to existing files are not copies | REQUEST_APPROVAL |
