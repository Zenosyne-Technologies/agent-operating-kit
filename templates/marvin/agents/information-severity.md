...
|---|---|---|
| `critical` | read it BEFORE you act, and attest to it on your final message's reserved `INFORMATION:` line (the FINAL MESSAGE spec ingredient in `briefing.md`) | read it anyway if your change enters the area it names — a critical rule binds by subject, not by role |
